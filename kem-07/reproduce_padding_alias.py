#!/usr/bin/env python3
"""Show that BRQC ciphertexts with changed padding bits decapsulate to the honest key."""
...
CONFIG = {  # library: (vector bytes, n, m)
    "kem-07/lib/libBRQC-128.so": (1890, 119, 127),
    "kem-07/lib/libBRQC-256.so": (3281, 161, 163),
    "kem-07/lib/libBRQC-512.so": (6498, 227, 229),
}
